...
/*   Updated: 2023/03/23 18:00:22 by wangthea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	const char	*msgarr[] = {"super debut de dingue", "pipe_", "_and_", "fd_in", "fd_ot", "_or__", "ifnot", "hrdoc", "appnd", "lfpar", "rtpar", "smcln", "space", "_tab_", "_ltr_","end_l", "_str_", "dolrs"};
	char		*msg;
